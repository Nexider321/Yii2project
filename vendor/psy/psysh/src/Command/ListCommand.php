    ...
    protected function configure()
    {
        ...
        $this
            ...
            ->setDefinition([
                ...
                new InputOption('categories', 'C', InputOption::VALUE_REQUIRED, 'Limit to constants in a specific categories (e.g. "date").'),
...
<return>>>> ls --constants --categories date</return>
